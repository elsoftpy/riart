		...
		<div class="browser-window">
	        ...
	        <div class="content">
				<form class="col s12" action="{{route('cargos_clientes.update', $dbData)}}" method="POST">
					...
					<h6 class="red-text"> Los montos se muestran en moneda local y en miles de Guaraníes </h6>
					<div class="row">
						<div class="input-field col s12">
							<input type="text" class="validate" id="descripcion" name="descripcion" value="{{$dbData->descripcion}}" disabled="disabled" style="color:black !important" />

    ...
    <body>
      <div class="container" style="width: 90% !important">
          <ul id="dropdown1" class="dropdown-content">
              <li><a href="{{ route('reportes.filter', $dbEmpresa) }}" id="intro-buscar">Buscar por Cargo</a></li>
              <li><a href="{{ route('reportes.cargosRubro', $dbEmpresa) }}" id="intro-universo">Universo de Cargos</a></li>
          </ul>
              ...
              <div class="nav-wrapper teal">
                  ...
                  @if(Auth::check())
                      <ul id="nav-mobile" class="right hide-on-med-and-down">
                        <li>
                          <a href="{{ route('reportes.panel', $dbEmpresa) }}" data-intro="<p class='intro-title'><strong>PANEL</strong></p>Acceda al listado de Empresas/Bancos participantes." data-step="27">Panel</a>
                        </li>
                        <li>
                          <a href="{{ route('reportes.conceptos', $dbEmpresa) }}" data-intro="<p class='intro-title'><strong>CONCEPTOS TECNICOS</strong></p>Acceda al diccionario de conceptos utilizados en la plataforma." data-step="26">Conceptos Técnicos</a>
                        </li>                      
                        <li>
                          <a href="{{ route('reportes.metodologia', $dbEmpresa) }}" data-intro="<p class='intro-title'><strong>METODOLOGIA</strong></p>Descripción del procedimiento realizado para la recolección de la información y la presentación de los resultados." data-step="28">Metodología</a>
                        </li>
                        <li>
